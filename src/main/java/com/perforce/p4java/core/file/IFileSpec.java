...
public interface IFileSpec extends IFileOperationResult {
	...
	/**
	 * @return the start revision for this file spec, if any. Returns
	...
	/**
	 * @return the resolve type for this file spec.
	 */
	 ...
	 *
	 * @param resolveType resolve type
	 */
	void setResolveType(String resolveType);

	/**
	 * @return the content resolve type for this file spec.
	 */
	 ...
	 *
	 * @param contentResolveType contentResolveType
	 */
	void setContentResolveType(String contentResolveType);

	/**
	 * @return the shelved change for this file spec.
	 */
	 ...
	 *
	 * @param shelvedChange shelvedChange
	 */
	void setShelvedChange(int shelvedChange);

	/**
	 * @return the file action associated with this file, if any. Returns
	...
	/**
	 * @return the label string associated with this file spec, if any. Returns
	...
	/**
	 * @return the file type string for this file spec, or null if not known.
	 */
	String getFileType();
	...
	/**
	 * @return the file this file spec was integrated from if any. Returns null
	 * if no such file.
	 */
	String getFromFile();
	...
	/**
	 * @return the "to" file for the integration, if it exists. Returns null
	 * otherwise.
	 */
	String getToFile();
	...
	/**
	 * @return the other action. Returns null if no such action.
	 */
	...
	/**
	 * @return the base revision as reported by integ -o or equivalent. This
	...
	/**
	 * @return the base name as reported by integ -o or equivalent. This
	...
	/**
	 * @return the base file as reported by resolve -o or equivalent. This
	 ...
	 * @param contentHistory      if true, return the content history
	 ...
	 */
	Map<IFileSpec, List<IFileRevisionData>> getRevisionHistory(int maxRevs, boolean contentHistory, boolean includeInherited, boolean longOutput, boolean truncatedLongOutput) throws ConnectionException, RequestException, AccessException;
	 ...
	 */
	Map<IFileSpec, List<IFileRevisionData>> getRevisionHistory(GetRevisionHistoryOptions opts) throws P4JavaException;
	 ...
	 * @throws AccessException     if the Perforce server denies access to the caller
	 */
	List<IFileAnnotation> getAnnotations(DiffType wsOptions, boolean allResults, boolean useChangeNumbers, boolean followBranches) throws ConnectionException, RequestException, AccessException;
	 ...
	 * @throws AccessException     if the Perforce server denies access to the caller
	 */
	List<IFileSpec> move(int changelistId, boolean listOnly, boolean noClientMove, String fileType, IFileSpec toFile) throws ConnectionException, RequestException, AccessException;
