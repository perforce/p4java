...
public interface IFileAnnotation {
	...
	/**
	 * @return the lower version or change number for the associated annotation.
	 */
	int getLower();

	/**
	 * @return the upper version or change number for the associated annotation.
	 */
	int getUpper();

	/**
	 * @return the line being annotated. This will <i>not</i> include the associated newline
	 ...
	 * @return the line being annotated, with optional line ending processing based on
	...
	/**
	 * @return the associated depot path for this annotation, if one is available.
	...
	/**
	 * @return the ordering of this annotation in the associated allIntegrations
