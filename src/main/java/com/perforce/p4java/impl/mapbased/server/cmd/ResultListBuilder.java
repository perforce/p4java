...
public class ResultListBuilder {
	public static <T> List<T> buildNonNullObjectListFromCommandResultMaps(final List<Map<String, Object>> resultMaps, final Function<Map<String, Object>, T> construct) throws P4JavaException {
	...
	public static <T> List<T> buildNonNullObjectListFromNonMessageCommandResultMaps(final List<Map<String, Object>> resultMaps, final Function<Map<String, Object>, T> construct) throws P4JavaException {
		List<T> objectList = new ArrayList<>();
		if (resultMaps != null) {
			for (Map<String, Object> map : resultMaps) {
	...
	public static <T> T buildNullableObjectFromNonInfoMessageCommandResultMaps(final List<Map<String, Object>> resultMaps, final Function<Map<String, Object>, T> construct) throws RequestException, AccessException {
		T obj = null;
		if (resultMaps != null) {
			for (Map<String, Object> map : resultMaps) {
				if (map != null) {
	...
	public static List<IExtendedFileSpec> buildNonNullExtendedFileSpecListFromCommandResultMaps(final List<Map<String, Object>> resultMaps, final IOptionsServer server) throws AccessException, ConnectionException {
	...
	public static IFileSpec handleIntegrationFileReturn(final Map<String, Object> map, final IServer server) throws AccessException, ConnectionException {

		return handleIntegrationFileReturn(map, false, server);
	}

	public static IFileSpec handleIntegrationFileReturn(final Map<String, Object> map, final boolean ignoreInfo, final IServer server) throws AccessException, ConnectionException {
	...
	public static IFileSpec handleFileReturn(final Map<String, Object> map, final IServer server) throws AccessException, ConnectionException {
		if (nonNull(map)) {
			String errStr = ResultMapParser.handleFileErrorStr(map);
			if (isBlank(errStr)) {
				return new FileSpec(map, server, -1);
