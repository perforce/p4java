...
import static com.perforce.p4java.impl.mapbased.rpc.func.RpcFunctionMapKey.RESOLVE_BASE_FILE;
import static com.perforce.p4java.impl.mapbased.rpc.func.RpcFunctionMapKey.RESOLVE_BASE_REV;
import static com.perforce.p4java.impl.mapbased.rpc.func.RpcFunctionMapKey.RESOLVE_END_FROM_REV;
import static com.perforce.p4java.impl.mapbased.rpc.func.RpcFunctionMapKey.RESOLVE_FROM_FILE;
import static com.perforce.p4java.impl.mapbased.rpc.func.RpcFunctionMapKey.RESOLVE_START_FROM_REV;
...
public class ResolveRecord implements IResolveRecord {
	 ...
	 *
	 * @param resolveAction            resolveAction
	 * @param resolveBaseFile          resolveBaseFile
	 * @param resolveBaseRevision      resolveBaseRevision
	 * @param resolveEndFromRevision   resolveEndFromRevision
	 * @param resolveFromFile          resolveFromFile
	 * @param resolveStartFromRevision resolveStartFromRevision
	 */
	public ResolveRecord(FileAction resolveAction, String resolveBaseFile, int resolveBaseRevision, int resolveEndFromRevision, String resolveFromFile, int resolveStartFromRevision) {
	...
	public ResolveRecord(Map<String, Object> map, int recNum) {
		if ((map != null) && (recNum >= 0)) {
			try {
				...
				Log.error("Unexpected exception in ResolveRecord constructor: " + thr.getLocalizedMessage());
				Log.exception(thr);
			}
		}
	}
