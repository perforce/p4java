...
public class GetKeysOptions extends Options {
	 ...
	 *
	 * @param undocKey   undocKey
	 * @param nameFilter nameFilter
	 * @param maxResults maxResults
	 */
	public GetKeysOptions(boolean undocKey, String nameFilter, int maxResults) {
		super();
	...
	public List<String> processOptions(IServer server) throws OptionsException {
		this.optionList = this.processFields(OPTIONS_SPECS, this.isUndocKey(), this.getNameFilter(), this.getNameFilters(), this.getMaxResults());
