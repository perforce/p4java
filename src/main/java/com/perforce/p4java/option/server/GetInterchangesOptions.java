...
public class GetInterchangesOptions extends Options {
	 ...
	 * @param maxChangelistId maxChangelistId
	 * @param reverseMapping  reverseMapping
	 * @param biDirectional   biDirectional
	 */
	public GetInterchangesOptions(boolean showFiles, boolean longDesc, int maxChangelistId, boolean reverseMapping, boolean biDirectional) {
		super();
	 ...
	 * @param biDirectional   biDirectional
	 */
	public GetInterchangesOptions(boolean showFiles, boolean longDesc, int maxChangelistId, String branch, boolean reverseMapping, boolean biDirectional) {
		super();
		this.showFiles = showFiles;
		this.longDesc = longDesc;
		this.maxChangelistId = maxChangelistId;
	 ...
	 * @param biDirectional   biDirectional
	 */
	public GetInterchangesOptions(boolean showFiles, boolean longDesc, int maxChangelistId, String stream, String parentStream, boolean reverseMapping, boolean biDirectional) {
		super();
		this.showFiles = showFiles;
		this.longDesc = longDesc;
		this.maxChangelistId = maxChangelistId;
	...
	public List<String> processOptions(IServer server) throws OptionsException {
		this.optionList = this.processFields(OPTIONS_SPECS, this.isShowFiles(), this.isLongDesc(), this.getMaxChangelistId(), this.getBranch(), this.getStream(), this.getParentStream(), this.isReverseMapping(), this.isBiDirectional());
		return optionList;
	}
