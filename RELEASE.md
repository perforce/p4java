...
Requirements
	...
	* Java: full standard JDK 7 or later.  Implementation as
	...
	* Supported Platforms:
	  ...
	  * Mac OS X 10.5, 10.6, 10.7, 10.8, 10.9, 10.10(x86, x86_64)
...
Known Limitations
	...
	* P4Java is limited to working in JDK 6 or later environments unless
	  you supply a suitable implementation of the P4Java
